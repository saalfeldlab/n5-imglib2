...
//		final RealRandomAccessible< RealComposite< DoubleType > > dfield = makeDisplacementArray( sz );
	...
	public static FunctionRealRandomAccessible< RealComposite< DoubleType > > makeDisplacementFunction( long[] sz )
	{
...
//	public static RealRandomAccessible< RealComposite< DoubleType > > makeDisplacementArray( long[] sz )
//	{
...
//			dfieldSz[i] = sz[i-1];
//
//		final ArrayImg< DoubleType, DoubleArray > img = ArrayImgs.doubles( data, sz );
//		return Views.interpolate( Views.extendBorder( Views.collapseReal( img )), new NLinearInterpolatorFactory<RealComposite<DoubleType>>());
//	}
