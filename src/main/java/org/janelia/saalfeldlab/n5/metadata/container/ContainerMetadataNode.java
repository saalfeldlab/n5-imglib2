...
public class ContainerMetadataNode {
	...
	public static ContainerMetadataNode buildHelper(final AbstractGsonReader n5, N5TreeNode baseNode ) {
		...
		final Optional<HashMap<String, JsonElement>> attrs = getMetadataMapJson(n5, baseNode.getPath());
	...
	public static Optional<HashMap<String, JsonElement>> getMetadataMapJson(final AbstractGsonReader n5,
